...
todas as ocorrências do caractere ’a’ são substituı́das pelo caractere ’d’, as do ’b’ por ’e’, e assim
sucessivamente. Crie uma funcao iterativa que recebe uma string como parâmetro e retorna
